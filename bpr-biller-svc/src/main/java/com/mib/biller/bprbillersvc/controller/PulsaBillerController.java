...
public class PulsaBillerController {
    ...
    public GeneralResponse<BillerInquiryResponseMB> inquiry(@RequestHeader(value = "Customer-Id") UUID customerId,@Valid @RequestBody PulsaBillerInquiryRequest pulsaBillerRequest) {
        var billerInquiryRes = billerService.pulsaBillerInquiry(pulsaBillerRequest, customerId);
    ...
    public GeneralResponse<BillerPaymentResponse> payment(@RequestHeader(value = "Customer-Id") UUID customerId, @RequestBody PulsaBillerPaymentRequest pulsaBillerPaymentRequest) {
        var billerPaymentRes = billerService.pulsaBillerPayment(pulsaBillerPaymentRequest, customerId);
